...
//             if (event == HOME_NS::Events::DONE) {
//                 // During the transition from HOMING to HOMING_REVERSE, we
//                 will
...
//
///**
// * If we're in the homingStart state, then the machine has just been turned
// on.
...
//    // If we've been homing for more than 15 seconds, then the user should
//    check
