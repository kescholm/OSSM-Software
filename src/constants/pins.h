...
namespace Pins {
  ...
  namespace Driver {
    ...
    // drivers. N.b. to iHSV57 users - DIP switch #5 can be flipped to invert
    // motor direction entirely
  ...
  namespace Wifi {
    ...
    // TODO: #OSSM-21 No toggle switch should be required for control. The OSSM
    // should always listen for commands and should decide whether to act on
    // them based on the current control mode. constexpr int control_default =
    // LOCAL_CONTROLLER;
  }  // namespace Wifi
